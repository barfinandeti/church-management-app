...
export default async function NotificationsPage() {
    ...
    if (!session || !session.user.churchId) return null;
            ...
            <div className="grid gap-4">
                {notifications.length > 0 ? (
                    notifications.map((note) => (
                        <Card key={note.id} className="p-6 bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 hover:shadow-md transition-shadow">
                            <div className="flex gap-4">
                                ...
                                <div className="flex-1">
                                    <div className="flex justify-between items-start">
                                        ...
                                        <time className="text-xs text-slate-500 bg-slate-100 dark:bg-slate-800 px-2 py-1 rounded-full">
